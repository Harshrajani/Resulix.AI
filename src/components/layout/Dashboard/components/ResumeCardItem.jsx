...
function ResumeCardItem({resume,refreshData}) {
  ...
  return (
       ...
       <div className=''>
        ...
        <div className='p-14  bg-gradient-to-b from-teal-300 via-blue-400 to-violet-400
        h-[280px] 
          rounded-t-lg border-t-8 border-x-2 
        '
        style={{
        ...
        items-center justify-center h-[180px] '>
                {/* <Notebook/> */}
                <img src="/public/resume.png" width={80} height={80} />
              </div>
        </div>
        </Link>
        <div className=' p-3 flex justify-between  text-white font-bold rounded-b-lg shadow-lg text-lg'
         style={{
